...
public class cmtx2 extends AbstractForwardVehicleRoutingTransportCosts implements TransportDistance  {
   ...
   private Locations locations;
    ...
    public cmtx2(Locations locations) {
        super();
    ...
    public double getTransportCost(Location from, Location to, double time, Driver driver, Vehicle vehicle) {
        ...
        if (v.equals("vehicle1")){
                  if(f.equals("0")&&t.equals("1")||f.equals("1")&&t.equals("0")){costs=968;}
            else if (f.equals("0")&&t.equals("2")||f.equals("2")&&t.equals("0")){costs=967;/*cost matrix for vehicle2 here*/}
            else if (f.equals("0")&&t.equals("3")||f.equals("3")&&t.equals("0")){costs=968;/*cost matrix for vehicle3 here*/}
        ...
        else if (v.equals("vehicle2")){if(f.equals("0")&&t.equals("1")||f.equals("1")&&t.equals("0")){costs=1068;}
        ...
        else if (v.equals("vehicle3")){if(f.equals("0")&&t.equals("1")||f.equals("1")&&t.equals("0")){costs=1000;}
            else if (f.equals("0")&&t.equals("2")||f.equals("2")&&t.equals("0")){costs=67;/*cost matrix for vehicle2 here*/}
            else if (f.equals("0")&&t.equals("3")||f.equals("3")&&t.equals("0")){costs=68;/*cost matrix for vehicle3 here*/}
            else if (f.equals("2")&&t.equals("3")||f.equals("3")&&t.equals("2")){costs=45;/*cost matrix for vehicle4 here*/}
            else if (f.equals("1")&&t.equals("3")||f.equals("3")&&t.equals("1")){costs=0;/*cost matrix for vehicle5 here*/}
            else if (f.equals("1")&&t.equals("2")||f.equals("2")&&t.equals("1")){costs=45;/*cost matrix for vehicle6 here*/}}
        else if (v.equals("vehicle4")){if(f.equals("0")&&t.equals("1")||f.equals("1")&&t.equals("0")){costs=1200;}
            else if (f.equals("0")&&t.equals("2")||f.equals("2")&&t.equals("0")){costs=67;/*cost matrix for vehicle2 here*/}
            else if (f.equals("0")&&t.equals("3")||f.equals("3")&&t.equals("0")){costs=68;/*cost matrix for vehicle3 here*/}
            else if (f.equals("2")&&t.equals("3")||f.equals("3")&&t.equals("2")){costs=45;/*cost matrix for vehicle4 here*/}
            else if (f.equals("1")&&t.equals("3")||f.equals("3")&&t.equals("1")){costs=0;/*cost matrix for vehicle5 here*/}
            else if (f.equals("1")&&t.equals("2")||f.equals("2")&&t.equals("1")){costs=45;/*cost matrix for vehicle6 here*/}}
        else if (v.equals("vehicle5")){if(f.equals("0")&&t.equals("1")||f.equals("1")&&t.equals("0")){costs=1300;}
            else if (f.equals("0")&&t.equals("2")||f.equals("2")&&t.equals("0")){costs=67;/*cost matrix for vehicle2 here*/}
            else if (f.equals("0")&&t.equals("3")||f.equals("3")&&t.equals("0")){costs=68;/*cost matrix for vehicle3 here*/}
            else if (f.equals("2")&&t.equals("3")||f.equals("3")&&t.equals("2")){costs=45;/*cost matrix for vehicle4 here*/}
            else if (f.equals("1")&&t.equals("3")||f.equals("3")&&t.equals("1")){costs=0;/*cost matrix for vehicle5 here*/}
            else if (f.equals("1")&&t.equals("2")||f.equals("2")&&t.equals("1")){costs=45;/*cost matrix for vehicle6 here*/}}
        else if (v.equals("vehicle6")){if(f.equals("0")&&t.equals("1")||f.equals("1")&&t.equals("0")){costs=1250;}
            else if (f.equals("0")&&t.equals("2")||f.equals("2")&&t.equals("0")){costs=67;/*cost matrix for vehicle2 here*/}
            else if (f.equals("0")&&t.equals("3")||f.equals("3")&&t.equals("0")){costs=68;/*cost matrix for vehicle3 here*/}
            else if (f.equals("2")&&t.equals("3")||f.equals("3")&&t.equals("2")){costs=45;/*cost matrix for vehicle4 here*/}
            else if (f.equals("1")&&t.equals("3")||f.equals("3")&&t.equals("1")){costs=0;/*cost matrix for vehicle5 here*/}
            else if (f.equals("1")&&t.equals("2")||f.equals("2")&&t.equals("1")){costs=45;/*cost matrix for vehicle6 here*/}}
        else if (v.equals("vehicle7")){if(f.equals("0")&&t.equals("1")||f.equals("1")&&t.equals("0")){costs=1345;}
            else if (f.equals("0")&&t.equals("2")||f.equals("2")&&t.equals("0")){costs=67;/*cost matrix for vehicle2 here*/}
            else if (f.equals("0")&&t.equals("3")||f.equals("3")&&t.equals("0")){costs=68;/*cost matrix for vehicle3 here*/}
            else if (f.equals("2")&&t.equals("3")||f.equals("3")&&t.equals("2")){costs=45;/*cost matrix for vehicle4 here*/}
            else if (f.equals("1")&&t.equals("3")||f.equals("3")&&t.equals("1")){costs=0;/*cost matrix for vehicle5 here*/}

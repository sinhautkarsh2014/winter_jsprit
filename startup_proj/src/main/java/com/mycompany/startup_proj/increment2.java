...
public class increment2 {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        */
        ...
        VehicleRoutingProblem.Builder vrpBuilder1 = VehicleRoutingProblem.Builder.newInstance();
        ArrayList<VehicleRoutingProblemSolution> initsol = new ArrayList<VehicleRoutingProblemSolution>();        
        new VrpXMLReader(vrpBuilder1,initsol ).read("incre.xml");
        System.out.print(initsol.isEmpty());
        
        Service s1inc = Service.Builder.newInstance("7679")
                .setLocation(Location.newInstance("23080")).addTimeWindow(630, 1080)
                .addSizeDimension(0, 22).addSizeDimension(1, 222).setName("MT" + "-" + "23080" + "-" + "MT").build();
        ...
        vrpBuilder.addJob(s1inc).addVehicle(vehicle1).addVehicle(vehicle2).addVehicle(vehicle3).addVehicle(vehicle4).addVehicle(vehicle5).addVehicle(vehicle6).addVehicle(vehicle7);


        // vrpBuilder.setRoutingCost(new MultiVehTypeCosts(vrpBuilder.getLocations()));
        vrpBuilder.setFleetSize(VehicleRoutingProblem.FleetSize.INFINITE).addInitialVehicleRoutes(initsol.get(0).getRoutes());
